...
| 4 | [Multi-tenant isolation (89 tables) + mid-flight action-model migration](04-tenant-isolation-migration.md) | Data correctness & security | Cross-tenant leakage (213 manual filters, no backstop), non-atomic dual writes | 🟢 Plan agreed (RLS) |
