...
ACTION_PLAN_PROMPT_VERSION = "2026-05-25.action-plan-v1"
...
_VOICE_RULES = (
    "VOICE RULES (apply to every string field you emit)\n"
    ...
    "colons, commas, semicolons, or parentheses.\n"
    "- Banned filler: \"You did a great job\", \"It's important to\", "
    "\"Remember to\", \"Going forward, consider\", \"In conclusion\", "
    "\"Overall\", \"It's worth noting\", \"Make sure to\".\n"
