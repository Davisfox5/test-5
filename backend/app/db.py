...
# asyncpg uses 'ssl' not 'sslmode' — strip sslmode from URL and pass an
# SSLContext via connect_args. The context VERIFIES the server cert
# against the system CA bundle (Neon presents a publicly-trusted cert;
# the Docker image installs ca-certificates). Encrypted-but-unverified
# TLS is MITM-able — only fall back to that via the explicit
# DATABASE_SSL_NO_VERIFY escape hatch.
