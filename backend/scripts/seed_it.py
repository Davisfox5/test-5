#!/usr/bin/env python3
"""
seed_it.py — Seed 15 IT support calls into the Linda demo database.
...
IT_CALLS = [
    {
        ...
        "agent_email": "sam.patel@linda-ai.co",
        ...
        "segments": [
            {"speaker_id": "agent", "speaker_name": "Sam Patel", "sentiment": "neutral",
             "text": "Thanks for calling Linda technical support, this is Sam. Can I get your name and company?"},
            ...
            {"speaker_id": "customer", "speaker_name": "Raj Anand", "sentiment": "negative",
             "text": "Twilio shows the webhooks are being delivered. HTTP 200 responses. But nothing is in Linda. I double-checked the endpoint URL in our Twilio console."},
            {"speaker_id": "agent", "speaker_name": "Sam Patel", "sentiment": "neutral",
            ...
            {"speaker_id": "customer", "speaker_name": "Raj Anand", "sentiment": "neutral",
             "text": "Sure — it's https://api.linda.ai/webhooks/twilio/calls. Is that right?"},
            {"speaker_id": "agent", "speaker_name": "Sam Patel", "sentiment": "neutral",
            ...
            {"speaker_id": "agent", "speaker_name": "Sam Patel", "sentiment": "neutral",
             "text": "While you do that — also confirm your Twilio account SID is set in your Linda integration settings. Go to Admin > Integrations > Twilio and make sure the SID matches exactly."},
            {"speaker_id": "customer", "speaker_name": "Raj Anand", "sentiment": "neutral",
    ...
    },
    {
        ...
        "agent_email": "casey.rivera@linda-ai.co",
        ...
        "segments": [
            {"speaker_id": "agent", "speaker_name": "Casey Rivera", "sentiment": "neutral",
             "text": "Casey Rivera, Linda integrations. Hey Lauren, thanks for scheduling this. From what I remember, you're working on the Okta SSO setup?"},
            ...
            {"speaker_id": "agent", "speaker_name": "Casey Rivera", "sentiment": "neutral",
             "text": "I see it. Your ACS URL is correct. But look at your Name ID format — you have it set to EmailAddress but Linda expects the persistent format [laughs] . That's why the assertion is failing."},
            {"speaker_id": "customer", "speaker_name": "Lauren Moss", "sentiment": "neutral",
            ...
            {"speaker_id": "agent", "speaker_name": "Casey Rivera", "sentiment": "neutral",
             "text": "Um, that's a different issue — your Okta group isn't mapped to a Linda role. In your attribute statements, add a group attribute called 'linda_role' and assign the value 'admin' for your IT security group."},
            {"speaker_id": "customer", "speaker_name": "Lauren Moss", "sentiment": "neutral",
    ...
    },
    {
        ...
        "segments": [
            {"speaker_id": "agent", "speaker_name": "Sam Patel", "sentiment": "neutral",
             "text": "Linda technical support, Sam speaking. What can I help you with today?"},
    ...
    },
    {
        ...
        "segments": [
            {"speaker_id": "agent", "speaker_name": "Sam Patel", "sentiment": "neutral",
             "text": "Hey Felix, Sam Patel from Linda tech support. You filed a ticket about a 404 on the export endpoint?"},
            ...
            {"speaker_id": "customer", "speaker_name": "Felix Hartmann", "sentiment": "neutral",
             "text": "Sure. https://api.linda.ai/api/v2/calls/abc123/transcript/export. The call ID is definitely valid — I can see the call in the dashboard."},
            {"speaker_id": "agent", "speaker_name": "Sam Patel", "sentiment": "neutral",
    ...
    },
    {
        ...
        "segments": [
            {"speaker_id": "agent", "speaker_name": "Casey Rivera", "sentiment": "positive",
             "text": "Casey Rivera, integrations. Hey Tanya! Ready to get your Zoom recordings flowing into Linda?"},
            ...
            {"speaker_id": "agent", "speaker_name": "Casey Rivera", "sentiment": "positive",
             "text": "Right, right. The auto-import will take care of so that completely. Here's how it works: we use Zoom's webhook for recording completed events, pull the file from Zoom's cloud, process it through our pipeline, and it shows up in Linda within about 5 minutes of the call ending."},
            {"speaker_id": "customer", "speaker_name": "Tanya Brooks", "sentiment": "positive",
             "text": "Um, that's perfect. What do I need basically to do on the Zoom side?"},
            {"speaker_id": "agent", "speaker_name": "Casey Rivera", "sentiment": "neutral",
             "text": "Yeah. You'll need Zoom admin access. Go to the Zoom App Marketplace, find the Linda app, and install it. During installation it'll ask for permission to access cloud recordings — approve that. Then come back to Linda and go to Admin > Integrations > Zoom... right?"},
            {"speaker_id": "customer", "speaker_name": "Tanya Brooks", "sentiment": "neutral",
             "text": "Okay, I'm in the Zoom Marketplace. I see the Linda app. Installing now... it's asking for recording permissions and meeting host data. Approving. Okay, it says installed... you know what I mean?"},
            {"speaker_id": "agent", "speaker_name": "Casey Rivera", "sentiment": "neutral",
             "text": "Great. Now in Linda — Admin > Integrations > Zoom. You should see a green 'Connected' status."},
            {"speaker_id": "customer", "speaker_name": "Tanya Brooks", "sentiment": "positive",
    ...
    },
    {
        ...
        "segments": [
            {"speaker_id": "agent", "speaker_name": "Sam Patel", "sentiment": "neutral",
             "text": "Hi Dr. Okafor, Sam Patel from Linda technical support. I understand you're conducting a HIPAA compliance review of our platform?"},
            {"speaker_id": "customer", "speaker_name": "Dr. Renata Okafor", "sentiment": "neutral",
             "text": "That's correct. We're a covered entity and before we expand our Linda usage to include patient-facing call lines, our legal team requires verification of your PII handling and redaction capabilities."},
            {"speaker_id": "agent", "speaker_name": "Sam Patel", "sentiment": "neutral",
    ...
    },
    {
        ...
        "segments": [
            {"speaker_id": "agent", "speaker_name": "Casey Rivera", "sentiment": "positive",
             "text": "Casey Rivera, Linda integrations. Hey Priya! Excited to get your white-label portal set up today."},
            ...
            {"speaker_id": "agent", "speaker_name": "Casey Rivera", "sentiment": "neutral",
             "text": "Perfect. Custom domain setup has three parts: DNS configuration, SSL provisioning, and branding customization. Let's do DNS first. You'll need to add a CNAME record pointing insights.horizontelecom.com to your-tenant.linda.ai."},
            {"speaker_id": "customer", "speaker_name": "Priya Mehta", "sentiment": "neutral",
             "text": "What's our tenant subdomain?"},
            {"speaker_id": "agent", "speaker_name": "Casey Rivera", "sentiment": "neutral",
             "text": "Right, so, it's horizon-telecom.linda.ai. Add the CNAME from insights.horizontelecom.com to horizon-telecom.linda.ai and propagation usually takes 30 to 60 minutes."},
            {"speaker_id": "customer", "speaker_name": "Priya Mehta", "sentiment": "neutral",
            ...
            {"speaker_id": "customer", "speaker_name": "Priya Mehta", "sentiment": "neutral",
             "text": "One more thing — can we remove all Linda branding? Our customers shouldn't know this is built on Linda."},
            {"speaker_id": "agent", "speaker_name": "Casey Rivera", "sentiment": "positive",
             "text": "Fully supported. In White Label settings there's a 'Complete Brand Removal' toggle. That removes our logo from the UI, email footers, and report PDFs. The only place Linda appears after that is in legal agreements, which your team controls anyway."},
            {"speaker_id": "customer", "speaker_name": "Priya Mehta", "sentiment": "positive",
    ...
    },
    {
        ...
        "segments": [
            ...
            {"speaker_id": "customer", "speaker_name": "Oscar Mejia", "sentiment": "neutral",
             "text": "Our own SIP trunking through a third-party carrier. The audio streams to Linda via your WebSocket API."},
            {"speaker_id": "agent", "speaker_name": "Sam Patel", "sentiment": "neutral",
    ...
    },
    {
        ...
        "segments": [
            ...
            {"speaker_id": "customer", "speaker_name": "Michael Osei", "sentiment": "neutral",
             "text": "We have about 18 months of call recordings sitting in an S3 bucket — roughly 12,000 files. I need to get them all into Linda without someone manually uploading each one."},
            {"speaker_id": "agent", "speaker_name": "Casey Rivera", "sentiment": "positive",
    ...
    {
        "title": "BI Tool Data Connector — Connecting Linda to Power BI",
        "agent_email": "sam.patel@linda-ai.co",
        ...
        "segments": [
            {"speaker_id": "agent", "speaker_name": "Sam Patel", "sentiment": "neutral",
             "text": "Well, sam Patel, technical support. Hi Yuki — you're looking to connect Power BI to Linda data?"},
            {"speaker_id": "customer", "speaker_name": "Yuki Tanaka", "sentiment": "neutral",
             "text": "Yes. Our analytics team wants to build custom dashboards combining Linda metrics with our CRM and ERP data in Power BI. I need to understand what options we have."},
            {"speaker_id": "agent", "speaker_name": "Sam Patel", "sentiment": "neutral",
            ...
            {"speaker_id": "customer", "speaker_name": "Yuki Tanaka", "sentiment": "positive",
             "text": "That covers what we need. How do we authenticate from Power BI to Linda?"},
            {"speaker_id": "agent", "speaker_name": "Sam Patel", "sentiment": "neutral",
             "text": "OAuth 2.0. When you set up the connector in Power BI, it'll open a Linda login prompt. You authenticate once and Power BI stores the token. For automated refresh, you'll use a service account — I'd recommend creating one in Admin > Users with read-only data access. [laughs] "},
            {"speaker_id": "customer", "speaker_name": "Yuki Tanaka", "sentiment": "neutral",
            ...
            {"speaker_id": "customer", "speaker_name": "Yuki Tanaka", "sentiment": "positive",
             "text": "Good. One thing our team wants to do is combine call topics from Linda with deal stage from our CRM. Is there a way to pass a CRM deal ID through Linda so we can join the data?"},
            {"speaker_id": "agent", "speaker_name": "Sam Patel", "sentiment": "positive",
    ...
    },
    {
        ...
        "segments": [
            {"speaker_id": "agent", "speaker_name": "Sam Patel", "sentiment": "neutral",
             "text": "Right, so, dr. Okafor, Sam Patel from Linda. I'm calling with an update on the SSN redaction issue we identified during your compliance review."},
            {"speaker_id": "customer", "speaker_name": "Dr. Renata Okafor", "sentiment": "neutral",
    ...
    },
    {
        ...
        "segments": [
            {"speaker_id": "agent", "speaker_name": "Casey Rivera", "sentiment": "neutral",
             "text": "Um, casey Rivera, Linda support. What's the situation?"},
            ...
            {"speaker_id": "agent", "speaker_name": "Casey Rivera", "sentiment": "neutral",
             "text": "I see the pattern. When SSO is enabled, the system expects to match Okta user emails to Linda accounts. If the email in Okta doesn't exactly match the email on the Linda account, login fails."},
            ...
            {"speaker_id": "agent", "speaker_name": "Casey Rivera", "sentiment": "neutral",
             "text": "In Linda Admin > Users, export the user list as CSV. Compare the email column to what you have in Okta. Any mismatches will be your issue. Common ones are people who changed their last name and updated Okta but not Linda."},
            {"speaker_id": "customer", "speaker_name": "Jordan Reyes", "sentiment": "neutral",
            ...
            {"speaker_id": "agent", "speaker_name": "Casey Rivera", "sentiment": "neutral",
             "text": "Okay, so, update the email on the Linda accounts to match Okta exactly. That'll restore access immediately — no password reset, no re-provisioning. The SSO um match is purely on email."},
            {"speaker_id": "customer", "speaker_name": "Jordan Reyes", "sentiment": "neutral",
    ...
    },
    {
        ...
        "segments": [
            ...
            {"speaker_id": "customer", "speaker_name": "Alex Torres", "sentiment": "neutral",
             "text": "Hey Sam. We're implementing webhook signature validation — we wanna verify that events from Linda are actually from you and not spoofed. The signature in the header never matches what we compute."},
            {"speaker_id": "agent", "speaker_name": "Sam Patel", "sentiment": "neutral",
            ...
            {"speaker_id": "agent", "speaker_name": "Sam Patel", "sentiment": "neutral",
             "text": "The format is: HMAC-SHA256 of the string 'v1:' plus the Unix timestamp from the X-Linda-Timestamp header, plus a I mean colon, plus the raw body bytes. The secret is your webhook signing secret from Admin > Webhooks."},
            {"speaker_id": "customer", "speaker_name": "Alex Torres", "sentiment": "neutral",
    ...
    },
    {
        ...
        "segments": [
            {"speaker_id": "agent", "speaker_name": "Casey Rivera", "sentiment": "neutral",
             "text": "Casey Rivera, Linda. Hi Sophie — I understand this is about GDPR data deletion and retention settings?"},
            {"speaker_id": "customer", "speaker_name": "Sophie Dubois", "sentiment": "neutral",
             "text": "Okay, so, yes. We've received a right-to-erasure request from a customer whose calls were recorded through BrightPath's contact center. I need to delete all associated recordings and transcripts from Linda. How do we do that?"},
            {"speaker_id": "agent", "speaker_name": "Casey Rivera", "sentiment": "neutral",
