 ...
 *
 * Same filterable/paginated table that used to live at
 * /interactions, but rendered as a sibling tab under /customers per
 * the plan. The page header + upload button live on the parent
 * customers page; this component is body-only.
 */
...
export function AllInteractionsView() {
