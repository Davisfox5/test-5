 ...
 *
 * Filterable/paginated table of every analyzed call in the tenant. Rows
 * drill into ``/interactions/{id}`` for the full detail layout. Customers
 * own the account-grouped views; this page is the flat, time-ordered feed.
 */
